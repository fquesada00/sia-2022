...
if __name__ == "__main__":
    ...
    neural_network = NeuralNetwork(hidden_sizes=[], input_size=3, prediction_output_path=1, learning_rate=0.5,
    ...
    if training_method == 'all':
        ...
        error, holdout_sets = holdout_eval(input_dataset, expected_output, neural_network,
                                           activation_function=activation_function, training_ratio=training_ratio)
        ...
        average_error, min_error_sets = k_fold_cross_validation_eval(
            input_dataset, expected_output, neural_network, k=k, activation_function=activation_function)
