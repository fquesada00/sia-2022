...
class BenchmarkParameters():
    ...
    def __init__(self, selection_parameters, crossover_parameters, mutation_parameters, cut_condition_parameters, population_size, min_real, max_real, bounds, crossover_output_filename, mutation_output_filename, cut_condition_output_filename, selection_output_filename, initial_bounds_output_filename):
